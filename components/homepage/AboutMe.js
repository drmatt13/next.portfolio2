  ...
  return (
    <>
      ...
      <div className='relative pb-8 sm:pb-12'>
        <div 
          className="absolute top-0 w-full h-full opacity-25 dark:opacity-50 /shadow-lg brightness-150 dark:brightness-100 transform-gpu" 
          style={{
            backgroundImage: `url(images/home/clouds1.jpg)`,
        ...
        >
          <div className='w-full h-full bg-gradient-to-b from-blue-200/60 to-indigo-600/40 dark:from-slate-800 dark:to-purple-900/60'/>
        </div>
          ...
          >
            ...
            <div className="relative z-10 w-full md:w-96 sm:mb-6 md:mb-4 lg:mb-[1.7rem] md:mr-10 md:ml-6 lg:mr-28 lg:ml-8 xl:mr-32 xl:ml-10 2xl:mr-48 2xl:ml-12 md:float-right">
              <div className="flex flex-col items-center w-full scale-75 sm:scale-90 lg:scale-100">
                <div className="z-10 bg-red-400/20 rounded-full h-52 w-52 shadow-indigo-600/50 dark:shadow-purple-500/50 overflow-hidden">
            ...
            <p className='relative mx-5 md:mx-10 lg:mx-28 xl:mx-32 2xl:mx-48 mb-3 lg:mb-4 indent-6 transform-gpu'>
            ...
            <p className='relative mx-5 md:mx-10 lg:mx-28 xl:mx-32 2xl:mx-48 mb-2 md:mb-3 lg:mb-4 indent-6 transform-gpu'>
              <span className='-z-10 absolute md:-right-20 lg:-right-56 xl:-right-64 2xl:-right-96 h-full w-full translate-x-full'/>
