...
const Navbar = () => {
  const { darkMode, setDarkMode, mobile, setModal, toggleModal, nav, buttons, setButtons } = useContext(_appContext),
    router = useRouter(),
    navRef = useRef(),
    parentRef = useRef(),
    childRef = useRef();
          ...
          {buttons !== undefined && (
            ...
            >
              ...
              <NavButton
                ...
                onClick={() => toggleModal({ name: "contact" })}
              />
              <NavButton
                className="fas fa-question"
                onClick={() => toggleModal({ name: "about" })}
              />
            </div>
          )}
        </div>
