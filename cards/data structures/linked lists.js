...
"readme2 readme": `Singly Linked Lists

head     ->       tail
x1 -> x2 -> x3 -> x4 -> null`,

"javascript SinglyLinkedList.js": `class Node {
  constructor(val) {
    this.val = val
    this.next = null
  }
...
"javascript script.js": `// create new list
...
"readme2 readme": `Doubly Linked Lists

        head                 tail
null <-> x1 <-> x2 <-> x3 <-> x4 <-> null`,

"javascript DoublyLinkedLists.js": ` class Node {
  constructor(val) {
    this.val = val
    this.next = null
    this.prev = null
